...
class Productmultiplication extends Component {
    constructor() {
        super();
        this.state = {
            product: [
    ...
    increment = (data) => {
        let result = this.state.product.map(eachobject => {
            if (data.id === eachobject.id) {
                return {

                    ...eachobject,
                    rating: { ...eachobject.rating, count: eachobject.rating.count + 1 },
                    price: eachobject.price + eachobject.price * 0.1,
                }
            }
            else {
                return eachobject;
                ...
                <table>
                    <tbody>
...

                        {
                            ...
                            this.state.product.map((eachobject) => {

                                return (
                                    <div key={eachobject.id}>
                                        <Productlist data={eachobject} increment={this.increment} decrement={this.decrement}/></div>
...
export default Productmultiplication;

class Productlist extends Component {

    render() {
        // console.log("productlistening")
        return (
            <div>
                ...
                <button onClick={()=>this.props.decrement(this.props.data)}>-</button><br></br>
                {/* <button onClick={this.props.Communication()}>click to see product</button> */}
