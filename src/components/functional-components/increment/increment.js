        ...
        let result = this.state.product.map(eachobject => {
            if (data.id === eachobject.id) {
                return {
                    ...
                    ...eachobject, rating: { ...eachobject.rating, count: eachobject.rating.count + 1 }
                }
            }
            else {
                return eachobject;
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button onClick={() => this.props.Communication(this.props.data)}>click to see product</button>
