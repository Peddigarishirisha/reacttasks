...
//         console.log(eachitem.price); // You can use console.log for debugging purposes
//         return (
//           <div>
//             {eachitem.price}
//             <p>{eachitem.title}</p>
...
// const Array=["https://fakestoreapi.com/img/81fPKd-2AYL.AC_SL1500.jpg" ,"https://fakestoreapi.com/img/81fPKd-2AYL.AC_SL1500.jpg" ,"https://fakestoreapi.com/img/81fPKd-2AYL.AC_SL1500.jpg" ]
...
return(
   ...
   <table>
    ...
    {Productinformation.map((eachitem)=>(
         <tr >
         <td><h4>{eachitem.id}</h4></td>   
        <td><h4>{eachitem.title}</h4></td>
        <td><h4>{eachitem.description}</h4></td>
<td><img src={eachitem.image}></img></td>
 
        <td><h4>{eachitem.price}</h4></td>
        <td><h4>{eachitem.rating.count}</h4></td>
